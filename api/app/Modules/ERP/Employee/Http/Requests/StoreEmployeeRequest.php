...
class StoreEmployeeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'cpf'               => ['required', 'string', 'max:25', 'unique:employees,cpf'],
    ...
    public function messages(): array
    {
        return [
            ...
            'position.exists'           => 'O cargo selecionado não existe.',
            'employee_code.required'    => 'O campo :attribute é obrigatório.',
            'employee_code.unique'      => 'O código do funcionário já está em uso.',
            ...
            'profile_picture.max'       => 'O campo :attribute não pode ser maior que 2MB.',
        ];
    }
