  ...
  try {
    ...
    if (axios.isAxiosError(error)) {
      ...
      if (response?.status === 422) {
        ...
        globalErrorMessage.value = 'Muitas tentativas. Por favor, aguarde um momento antes de tentar novamente.'
      } else {
        globalErrorMessage.value = 'Não foi possível estabelecer ligação com o servidor. Tente mais tarde.'
      }
    } else {
...
<template>
  <div
    ...
    <form @submit.prevent="handleSubmit" class="space-y-4" novalidate>
      ...
      <div class="mb-6 p-4 bg-gray-50 dark:bg-gray-950/30 border-l-4 border-gray-500 text-sm text-gray-700 dark:text-gray-400 rounded-r-md">
        Durante o desenvolvimento, usar as credenciais <strong>admin@conciliador.com.br</strong> e <strong>admin123</strong> para acessar o sistema.
      </div>
