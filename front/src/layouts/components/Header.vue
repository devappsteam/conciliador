...
<template>
  <header
    class="sticky top-0 z-40 flex items-center justify-between w-full h-16 px-6 bg-white dark:bg-gray-800 shadow-sm border-b border-gray-100 dark:border-gray-700">

    <button class="text-gray-500 focus:outline-none md:hidden hover:text-gray-700 dark:hover:text-gray-300"
    ...
    <div class="flex items-center space-x-4">
      ...
      <button @click="handleLogout" title="Terminar Sessão"
