...
import { LayoutDashboard, Users2, type LucideIcon } from '@lucide/vue';
...
const menuStructure: MenuGroup[] = [
  ...
  {
    name: 'Configurações',
    items: [{ label: 'Gestão de Usuários', routeName: 'settings.users', icon: Users2 }],
  },
]
</script>
  ...
  >
    <div class="flex items-center justify-between h-16 px-6 border-b border-gray-800">
      <span class="text-lg font-bold text-white tracking-wider">
        <img src="https://devapps.com.br/assets/images/logo.png" alt="Logo - DevApps" class="h-8 w-auto" />
      </span>
